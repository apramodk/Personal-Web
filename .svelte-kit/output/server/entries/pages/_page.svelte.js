...
const headshot = "/Personal-Web/_app/immutable/assets/headshot-66f76d4b.jpg";
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `<main class="${"svelte-dbaro6"}"><div class="${"card card-side bg-neutral shadow-xl"}"><figure class="${"object-cover"}"><img${add_attribute("src", headshot, 0)} alt="${"img"}"></figure>
        <div class="${"card-body"}"><h2 class="${"card-title text-primary"}">Welcome to my website!</h2>
            <p>My name is Akash Pramod. I&#39;m currently attending the University of Tennessee at Knoxville   <br> 
