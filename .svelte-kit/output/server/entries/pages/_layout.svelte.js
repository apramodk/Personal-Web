...
const Navbar = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<div class="${"navbar bg-base-300"}"><div class="${"flex-1"}"><div class="${"dropdown dropdown-hover shadow rounded-box"}"><a${add_attribute("href", base, 0)} class="${"btn btn-ghost normal-case text-xl text-primary hover:text-warning "}">APK</a>
