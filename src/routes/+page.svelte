    ...
    <div class="card card-side text-primary">
        <div class="card-body">
            <h2 class="card-title text-center">
                <h1 class="text-4xl">
                    <span class="hover:text-base-content">Akash</span> 
                    <span class="hover:text-base-content">Pramod</span> 
                    <span class="hover:text-base-content">Kumar</span>
                </h1>
            </h2>
            <p>
            ...
            <span>
                My name is 
                <span class="text-warning">Akash Pramod Kumar</span>.
                I'm currently attending the 
                <span class="text-orange-600">University of Tennessee Knoxville</span>                         <br/>
                ...
                some of the things you'll find on my website.                                                  <br/>
            </span>
        </div>
    </div>
</main>
